            ...
            <div class="mt-16">
                ...
                @if($results->isEmpty())
                    <div class="text-center py-16 px-8 bg-gray-800/50 border border-dashed border-gray-700 rounded-lg">
                        ...
                        <p class="mt-2 text-sm text-gray-400">We couldn't find any documents matching your search. Try using different keywords.</p>
                    </div>
                @else
                    <div class="space-y-5">
                        @foreach($results as $doc)
                            <a href="{{-- route('documents.show', $doc->id) --}}" class="block p-6 bg-gray-800 border border-gray-700 rounded-lg shadow hover:bg-gray-700/50 hover:border-blue-600 transition-all duration-200">
